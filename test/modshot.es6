...
describe('CLI validation', () => {
    ...
    describe('Static HTML file input validation', () => {
        ...
        //         glob('test/fixtures/**/*.png', (er, files) => {
        ...
        //         assert.include(stdout, 'PASS', 'Output message should have the string PASS');
        //         glob('test/fixtures/box/**/*.png', (er, files) => {
        //             assert.isNull(er, 'Error should be null when retrieving screenshot png files');
        ...
        //         assert.include(stdout, 'PASS', 'Output message should have the string PASS');
        //         glob('test/screenshots/*.png', (er, files) => {
        ...
        //         assert.include(stdout, 'PASS', 'Output message should have the string PASS');
        //         glob('test/prefix/static/screenshots/modshot-*.png', (er, files) => {
        //             assert.isNull(er, 'Error should be null when retrieving screenshot png files from output dir');
        //             assert.equal(files.length, 4);
        //             done();
        //         });
    ...
    describe('URL input validation', () => {
        ...
        //         assert.include(stdout, 'PASS', 'Output message should have the string PASS');
        //         glob('test/url/full/screenshots/*.png', (er, files) => {
        //             assert.isNull(er, 'Error should be null when retrieving screenshot png files from output dir');
        ...
        // it(`should generate screenshot for a URL in the test/url/full directory
        //     with cookie & domain options`, done => {
        ...
        // it(`should generate screenshots for a URL in test/url/selectors
        //     directory for the provided selectors`, done => {
        //     exec('node bin/modshot -u http://pages.ebay.com/sitemap.html -o test/url/selectors/ -s h1 -s h2' +
        //     toleranceOption, (error, stdout) => {
        //         assert.include(stdout, 'PASS', 'Output message should have the string PASS');
        //         glob('test/url/selectors/screenshots/*.png', (er, files) => {
        //             assert.isNull(er, 'Error should be null when retrieving screenshot png files from output dir');
        //             assert.isAbove(files.length, 0);
        //             done();
        //         });
        ...
        //     toleranceOption, (error, stdout) => {
        //         assert.include(stdout, 'PASS', 'Output message should have the string PASS');
        //         glob('test/prefix/url/screenshots/modshot-*.png', (er, files) => {
        //             assert.isNull(er, 'Error should be null when retrieving screenshot png files from output dir');
        //             assert.equal(files.length, 2);
        //             done();
        //         });
        ...
        //             assert.isNull(er, 'Error should be null when retrieving screenshot png files from output dir');
        //             assert.equal(files.length, 2);
        //             glob('test/fixtures/**/*.png', (err, fileList) => {
        //                 assert.isNull(err, 'Error should be null when retrieving screenshot png files');
        //                 assert.isAbove(fileList.length, 0);
        //                 done();
        //             });
        //         });
        //     });
